...
public class TicTacToe {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.print("1 dan 9 gacha raqamlangan katakchaga mos son kiriting: ");
            int playerPos = sc.nextInt();
            while (playerPositions.contains(playerPos) || compPositions.contains(playerPositions)) {
                System.out.println("Katak egallangan! Boshqasini tanlang !!!");
    ...
    public static String checkWinner() {
        ...
        for (List l: winning) {
            if (playerPositions.containsAll(l)) {
                System.out.println("G'alaba qatori: " + l);
                return "Tabriklaymiz! Siz yutdingiz !!!";
            } else if (compPositions.containsAll(l)) {
                System.out.println("G'alaba qatori: " + l);
                return "Afsuski siz yutqazdingiz :(";
